...
public class StringUtils {
    ...
    public static Long[] longStringDistinctToArray(String sour, String regex) {
        if (StringUtils.isEmpty(sour))
            return null;

        String[] split = sour.split(regex);
        if (split.length == 0)
            return null;
    ...
    public static int[] intStringDistinctToArray(String sour, String regex) {
        ...
        return org.springframework.util.StringUtils.isEmpty(sour) ? null :
    ...
    public static String[] stringArrayToArray(String sour, String regex) {
        return org.springframework.util.StringUtils.isEmpty(sour) ? null : sour.split(regex);
    }
    ...
    public static String intArrayToString(int[] arr, String join) {
        if (Util.isArrayEmpty(arr)) return "";
    ...
    public static boolean isBlank(String title) {
        return title == null || title.length() == 0 || title.trim().length() == 0;
    }
}
