...
import com.duan.blogos.dao.dto.blog.*;
import com.duan.blogos.dao.dto.blogger.*;
import com.duan.blogos.dao.dto.blogger.BlogListItemDTO;
import com.duan.blogos.dao.entity.blog.*;
import com.duan.blogos.dao.entity.blogger.BloggerAccount;
import com.duan.blogos.dao.entity.blogger.BloggerLink;
...
public class DataFillingManager {
    ...
    public com.duan.blogos.dao.dto.blog.BlogListItemDTO blogListItemToDTO(BlogStatistics statistics, BlogCategory[] categories, BlogLabel[] labels,
                                                                          Blog blog, String blogImg) {
        com.duan.blogos.dao.dto.blog.BlogListItemDTO dto = new com.duan.blogos.dao.dto.blog.BlogListItemDTO();
    ...
    public FavouriteBlogListItemDTO collectBlogListItemToDTO(int bloggerId, BlogCollect collect, com.duan.blogos.dao.dto.blog.BlogListItemDTO blog, BloggerDTO author) {
    ...
    public FavouriteBlogListItemDTO likeBlogListItemToDTO(int bloggerId, BlogLike like, com.duan.blogos.dao.dto.blog.BlogListItemDTO blog, BloggerDTO liker) {
        FavouriteBlogListItemDTO dto = new FavouriteBlogListItemDTO();
        dto.setAuthor(liker);
        dto.setBlog(blog);
        dto.setBloggerId(bloggerId);
